<?php return array (
  ...
  array (
    'popular' => 
    array (
      'new' => 'Prova qualcosa di nuovo',
      'restaurant' => 'Ristoranti più popolari',
      'See all restaurants' => 'Tutti i ristoranti',
    ),
    'cities' => 
    array (
      'restaurants' => 'Ristoranti',
      'popular' => 'Città più popolari',
      'popular_subtitle' => 'Trova la tua città',
      'see_all' => 'Tutte le città',
    ),
    'steps' => 
    array (
      'title' => '',
      'txt' => 'Come Foodtribù lavora per te',
      'find_title' => 'Trova il luogo perfetto',
      'find_txt' => 'Cerca tra i ristoranti vicino casa tua',
      'buy_title' => 'Prenota',
      'buy_txt' => 'Contatta il ristorante tramite numero di telefono',
      'enjoy_title' => 'Goditi il tuo pranzo',
      'enjoy_txt' => 'Ordina e fatti spedire il tuo pranzo',
      'earn_title' => 'Dai una votazione',
      'earn_txt' => 'Dai una votazione ai tuoi ristoranti preferiti',
    ),
    'spottwo' => 
    array (
      'title' => 'Inizia ad usare la directory oggi',
      'sub_title' => 'E\' il miglior modo per scoprire i migliori ristoranti',
      'txt' => '',
    ...
    'become_bell_boy' => 
    array (
      'title' => 'Vuoi diventare fattorino',
      'sub_title' => 'dei nostri ristoranti?',
      'txt' => '',
      'create_account' => 'Diventa fattorino',
      'free' => '',
    ),
  ),
  'pages' => 'Le nostre pagine',
  'index' => 
  array (
    'steps' => 
    array (
