...
• Bruno Giada - Correo electrónico del propietario: staff@foodtribu.com

Finalidad del tratamiento.
Entre los datos personales recopilados por esta Aplicación, de forma independiente o a través de terceros, se encuentran: Cookies, datos de uso, datos comunicados durante el uso del servicio, correo electrónico, identificadores únicos de dispositivos para publicidad, diversos tipos de datos, Nombre, apellidos, número de teléfono, profesión, provincia, estado, país, código postal, sexo, fecha de nacimiento, ciudad, dirección, nombre de la empresa y sitio web. Los datos personales pueden ser proporcionados libremente por el usuario o, en el caso de los datos de uso, recopilados automáticamente durante el uso de esta aplicación. A menos que se especifique lo contrario, todos los datos requeridos por esta aplicación son obligatorios. Si el Usuario se niega a comunicarlos, puede ser imposible que esta Aplicación proporcione el Servicio. El Usuario asume la responsabilidad de los Datos Personales de terceros obtenidos, publicados o compartidos a través de esta Aplicación y garantiza el derecho a comunicarse o difundirlos, liberando al Propietario de cualquier responsabilidad ante terceros.
