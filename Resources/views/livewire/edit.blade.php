<!-- Modal -->
<div wire:ignore.self class="modal fade" id="editPlacesModal" tabindex="-1" role="dialog"
    aria-labelledby="editPlacesModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editPlacesModalLabel">Modal title</h5>
