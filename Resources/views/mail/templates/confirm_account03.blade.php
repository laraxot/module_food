                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="font-family:'Open+Sans', 'Open Sans', Helvetica, Arial, sans-serif; font-size:13px; line-height:18px; color:#00C0EA; text-align:center; width:152px;">
                          ...
                          <tbody><tr>
                            <td style="padding:20px 0 10px 0;">
                              <a href="#tba" style="text-decoration:none;" target="_blank"><img alt="Udacity" border="0" height="27" src="https://s3-us-west-1.amazonaws.com/udacity-content/rebrand/images/Udacity_Email_Logo.png" style="display:block; width:152px !important; font-family:'Open+Sans', 'Open Sans', Helvetica, Arial, sans-serif; font-size:22px; line-height:26px; color:#000000; text-transform:uppercase; text-align:center; letter-spacing:1px;" width="152"></a>
                            </td>
                          </tr>
...
<tr>
	<td style="padding-top:30px;">
		...
		<p style="Margin:20px 0; font-size:12px; line-height:17px; word-wrap:break-word; word-break:break-all;"><a href="https://www.udacity.com/" style="color:#5885ff; text-decoration:underline;" target="_blank">https://www.udacity.com/account/verify_email?user_key=6500005000&amp;code=6500500</a></p>
	</td>
</tr>
