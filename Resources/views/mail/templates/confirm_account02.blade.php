    ...
    bgcolor="#F4F7FA">
      <tbody>
        <tr>
          ...
          <a href="https://www.coinbase.com/signin" style="display:block; padding:15px 25px; background-color:#0087D1; color:#ffffff; border-radius:3px; text-decoration:none;">Verify Email Address</a>
        </span>
